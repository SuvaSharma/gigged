                      ...
                      Container(
                        ...
                        child: Column(
                            ...
                            children: [
                              Expanded(
                                  child: Image.network(
                                      'https://www.highreshdwallpapers.com/wp-content/uploads/2014/03/Sexy-Beyonc%C3%A9-Wallpaper.jpg')),
                              Expanded(
                                child: Padding(
                                    padding: const EdgeInsets.symmetric(
                                        horizontal: 10),
                      ...
                      Container(
                        ...
                        child: Column(
                            ...
                            children: [
                              Expanded(
                                  child: Image.network(
                                      'https://hablatumusica.com/wp-content/uploads/2012/10/Adele+png.png')),
                              Expanded(
                                child: Padding(
                                    padding: const EdgeInsets.symmetric(
                                        horizontal: 10),
                      ...
                      Container(
                        ...
                        child: Column(
                            ...
                            children: [
                              Expanded(
                                  child: Image.network(
                                      'https://www.pngitem.com/pimgs/m/725-7258845_thumb-image-ed-sheeran-png-transparent-png.png')),
                              Expanded(
                                child: Padding(
                                    padding: const EdgeInsets.symmetric(
                                        horizontal: 10),
